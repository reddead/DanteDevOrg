angularApp.controller('PersonalDataCtrl', function($scope, ngForceConfig, DataService, MyProfileService) {
    ...
    if(dataResults){
      ...
      $scope.next = function(isNext) {
          ...
          //$scope.contact.Date_of_Birth__c=$scope.contact.Date_of_Birth__c.toISOString().substring(0, 10);
